...
import { ReaderSurahSearchService } from './reader-surah-search.service';
import { ReaderTafsirPanelService } from './reader-tafsir-panel.service';
import { ReaderVerseFragmentService } from './reader-verse-fragment.service';
import { ReaderViewPreferencesService } from './reader-view-preferences.service';
...
export class ReaderRouteCoordinatorService {
  ...
  private applyCorpusAndRoute(
    ...
    if (this.activeAyah.pendingStartAyah !== null) {
      this.scheduleFulfillPendingStart();
    }
  }

  scheduleFulfillPendingStart(): void {
    this.fragments.verseFragmentSyncEnabled = false;
    /* afterNextRender is invoked by the shell component */
  }
}
